...
(cl:in-package serviec_demo-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <Greeting-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Greeting-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name serviec_demo-srv:<Greeting-request> is deprecated: use serviec_demo-srv:Greeting-request instead.")))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <Greeting-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader serviec_demo-srv:name-val is deprecated.  Use serviec_demo-srv:name instead.")
  (name m))

(cl:ensure-generic-function 'age-val :lambda-list '(m))
(cl:defmethod age-val ((m <Greeting-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader serviec_demo-srv:age-val is deprecated.  Use serviec_demo-srv:age instead.")
  (age m))
...
(cl:defmethod cl:initialize-instance :after ((m <Greeting-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Greeting-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name serviec_demo-srv:<Greeting-response> is deprecated: use serviec_demo-srv:Greeting-response instead.")))

(cl:ensure-generic-function 'feedback-val :lambda-list '(m))
(cl:defmethod feedback-val ((m <Greeting-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader serviec_demo-srv:feedback-val is deprecated.  Use serviec_demo-srv:feedback instead.")
  (feedback m))
